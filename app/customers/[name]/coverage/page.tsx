...
export default function CoveragePage() {
  ...
  const displayName = name === '신규고객' ? '신규 고객' : name;
  ...
  return (
    <main style={mainStyle}>
      ...
      <div style={topBarStyle}>
        <button
          onClick={() => name === '신규고객' ? router.push('/new') : router.push('/customers/' + encodeURIComponent(name)) }
      ...
      <div style={summaryCardStyle}>
        <h1 style={{ margin: 0 }}>{displayName} · 보장분석</h1>
      ...
      <div style={bottomButtonWrap}>
        ...
        <button
          ...
          onClick={() => alert('다음 단계에서 AI 부족분 분석으로 연결됩니다!')}
        >
          AI 분석 시작
        </button>
      </div>
  ...
  return (
    <div>
      ...
      <div style={moneyWrapStyle}>
        <input placeholder='0' style={moneyInputStyle} />
